...
const rest = require("./lib/defaultContentREST.js").instance;
const fS = require("./lib/defaultContentFS.js").instance;
...
class DefaultContentHelper extends JSONItemHelper {
    constructor (enforcer) {
        if (enforcer !== singletonEnforcer) {
            throw i18n.__("singleton_construct_error", {classname: "DefaultContentHelper"});
        }
        super(rest, fS, "default-content");
    }

    static get instance() {
        if (!this[singleton]) {
            this[singleton] = new DefaultContentHelper(singletonEnforcer);
        }
...
module.exports = DefaultContentHelper;
