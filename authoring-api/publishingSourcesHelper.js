...
const rest = require("./lib/publishingSourcesREST").instance;
const fS = require("./lib/publishingSourcesFS").instance;
...
class PublishingSourcesHelper extends JSONItemHelper {
    /**
     * The constructor for a PublishingSourcesHelper object. This constructor implements a singleton pattern, and will
    ...
    static get instance() {
        if (!this[singleton]) {
            this[singleton] = new PublishingSourcesHelper(singletonEnforcer);
        }
...
/**
 * Export the PublishingSourcesHelper class.
 */
module.exports = PublishingSourcesHelper;
