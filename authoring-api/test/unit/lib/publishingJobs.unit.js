...
class PublishingJobsUnitTest extends UnitTest {
    ...
    static get INVALID_PUBLISHING_JOBS_DIRECTORY() { return UnitTest.API_PATH + UnitTest.INVALID_RESOURCES_DIRECTORY + PublishingJobsUnitTest.PUBLISHING_JOBS_DIRECTORY; };
