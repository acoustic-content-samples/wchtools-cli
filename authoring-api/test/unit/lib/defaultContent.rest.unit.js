...
const lookupUri =  options.getProperty(UnitTest.DEFAULT_API_CONTEXT, "default-content", "uri");
...
class DefaultContentRestUnitTest extends BaseRestUnitTest {
    constructor() {
        super();
    }
    run(){
        super.run(restApi, lookupUri, "default-content", path1, path2);
...
module.exports = DefaultContentRestUnitTest;
