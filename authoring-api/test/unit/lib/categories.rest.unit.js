...
*/
/**
 * Unit tests for the CategoriesREST object.
 */
"use strict";
...
// Get the "lookup" URI for categories.
const lookupUri =  options.getProperty(UnitTest.DEFAULT_API_CONTEXT, "categories", "uri");
...
class CategoriesRestUnitTest extends BaseRestUnit {
    constructor() {
        super();
    }
    run(){
        super.run(restApi, lookupUri, "categories", path1, path2);
    }
}

module.exports = CategoriesRestUnitTest;
