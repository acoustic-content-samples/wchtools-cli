...
class DefaultContentFsUnitTest extends BaseFsUnit {
    constructor() {
        super();
    }
    run() {
        super.run(fsApi, DefaultContentUnitTest.VALID_CONTENT_1, DefaultContentUnitTest.VALID_CONTENT_2);
    }
}

module.exports = DefaultContentFsUnitTest;
