...
*/
/**
 * Unit tests for the publishingSourcesREST object.
 */
"use strict";
...
const lookupUri =  options.getProperty(UnitTest.DEFAULT_API_CONTEXT, "sources", "uri");
...
class PublishingSourcesRestUnitTest extends BaseRestUnit {
    constructor() {
        super();
    }
    run(){
        super.run(restApi, lookupUri, "sources", path1, path2);
    }
}

module.exports = PublishingSourcesRestUnitTest;
