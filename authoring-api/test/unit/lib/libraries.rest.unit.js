...
*/
/**
 * Unit tests for the LibrariesREST object.
 */
"use strict";
...
// Get the "lookup" URI for libraries.
const lookupUri =  options.getProperty(UnitTest.DEFAULT_API_CONTEXT, "libraries", "uri");
...
class LibrariesRestUnitTest extends BaseRestUnit {
    constructor () {
        super();
    }

    run () {
        super.run(restApi, lookupUri, "libraries", path1, path2);
    }
}

module.exports = LibrariesRestUnitTest;
