...
*/
/**
 * Unit tests for the LayoutsREST object.
 */
"use strict";
...
const lookupUri =  options.getProperty(UnitTest.DEFAULT_API_CONTEXT, "layouts", "uri");
...
class LayoutsRestUnitTest extends BaseRestUnit {
    constructor() {
        super();
    }
    run(){
        super.run(restApi, lookupUri, "layouts", path1, path2);
    }
}

module.exports = LayoutsRestUnitTest;
