...
pullUnitTest.run(helper, rest, fs, '--image-profiles', BASE_NAME + '-1', BASE_NAME + '-2', BASE_NAME + '-bad-name', '_smd.json');

const PushUnitTest = require("./lib/push.unit.js");
const pushUnitTest = new PushUnitTest();
pushUnitTest.run(helper, rest, fs, '--image-profiles', BASE_NAME + '-1', BASE_NAME + '-2', BASE_NAME + '-bad-name', '_smd.json');
