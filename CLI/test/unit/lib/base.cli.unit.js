...
class UnitTest {
    ...
    static get DUMMY_DIR () { return cliPath + "/test/unit/dummy" + path.sep; };
    ...
    static get DUMMY_CONTENT () { return "test"; };
    static get DUMMY_METADATA () { return {"id": "xxx", "path": "test1"}; };
    static get DUMMY_METADATA_ARRAY () { return [{"id": "xxx", "path": "test1"}, {"id": "yyy", "path": "test2"}]; };
     ...
     *
     * NOTE: Any files contained within the specified directory will also be removed.
     *
     * @param {String} path - File path to the directory being removed.
     */
    static removeTestFiles (path) {
        rimraf.sync(path);
    };
